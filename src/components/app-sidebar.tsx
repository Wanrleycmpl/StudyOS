    ...
    <>
      <aside className="fixed inset-y-0 left-0 hidden w-64 flex-col border-r border-slate-200 bg-white px-4 py-5 lg:flex">
        <Link className="flex items-center gap-2 px-2" href="/dashboard">
          ...
          <span className="text-lg font-semibold tracking-tight text-slate-950">StudyOS</span>
        </Link>
        <nav className="mt-10 flex flex-col gap-1">{links}</nav>
        <div className="mt-auto rounded-lg bg-slate-50 p-3">
          <p className="truncate text-sm font-medium text-slate-800">Minha conta</p>
      ...
      <header className="sticky top-0 z-10 border-b border-slate-200 bg-white/95 px-4 py-3 backdrop-blur lg:hidden">
        <div className="mb-3 flex items-center gap-2">
          ...
          <span className="font-semibold tracking-tight text-slate-950">StudyOS</span>
        </div>
